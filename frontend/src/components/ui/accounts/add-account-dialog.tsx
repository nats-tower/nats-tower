...
import type { NatsAuthAccountsRecord } from "@/lib/pocketbase-types";
...
export function AddAccountDialogContent({
	setDialogCreateAccountOpen,
	installationData,
	mutateAccounts,
}: AddAccountDialogContentProps) {
		...
		<DialogContent className="max-w-2xl">
			<Form {...form}>
				<form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
					<DialogHeader>
						<DialogTitle>
							Add account for installation '{installationData.description}'
						</DialogTitle>
						<DialogDescription>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											This description should be meaningful and concise.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										/>
										<FormDescription>
											Choose which teams should have access to this account. If
											no teams are selected, all teams will have access.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
