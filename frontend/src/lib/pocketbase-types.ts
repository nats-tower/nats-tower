...
export type NatsAuthAccountsResponse<Texpand = unknown> =
...
export type TeamsResponse<Texpand = unknown> = Required<TeamsRecord> &
	BaseSystemFields<Texpand>;
export type UsersResponse<Tpreferences = unknown, Texpand = unknown> = Required<
	UsersRecord<Tpreferences>
> &
	AuthSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
	...
	collection(
		idOrName: "nats_auth_accounts",
	): RecordService<NatsAuthAccountsResponse>;
	collection(
	...
	collection(
		idOrName: "nats_auth_limits",
	): RecordService<NatsAuthLimitsResponse>;
	collection(
